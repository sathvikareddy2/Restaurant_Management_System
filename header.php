                    ...
                    <div class="modal-body">   
                        ...
                        if(isset($_GET['error'])){
                            ...
                            if($_GET['error'] == "emptyfields") {   
                                ...
                                echo '<h5 class="bg-danger text-center">Invalid Username and Email, Please try again!</h5>';
                            }
                                ...
                                echo '<h5 class="bg-danger text-center">Password Do Not Match, Please try again!</h5>';
                            }
                            else if($_GET['error'] == "usertaken") {   
                                echo '<h5 class="bg-danger text-center">Username Already Taken, Please try again!</h5>';
                            }
                        }
                        else if(isset($_GET['signup']) && $_GET['signup'] == "success"){ 
                            // Script to show modal on signup success
                            echo '<script>
                                    $(document).ready(function(){
                                        $("#myModal_login").modal("show");
                                    });
